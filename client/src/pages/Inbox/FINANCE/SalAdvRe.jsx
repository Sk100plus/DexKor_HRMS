  ...
  return (
    <div className="p-6 text-[13px]">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <button
          className="hover:bg-gray-600 border px-4 py-2 rounded-none cursor-pointer hover:text-white text-sm"
          onClick={handleReset}
        >
          Reset
        </button>
        ...
        <button
          className="ml-auto border hover:bg-blue-700 hover:text-white px-4 py-1.5 rounded-none cursor-pointer"
          ...
          {filteredData.length === 0 ? (
            ...
            filteredData.map((item) => (
              <tr key={item.id} className="border-t text-sm">
                ...
                <td className="p-3">
                  <button className="px-4 py-1 hover:bg-gray-600 hover:text-white cursor-pointer border ">View</button>
                </td>
              </tr>
            ))
          )}
