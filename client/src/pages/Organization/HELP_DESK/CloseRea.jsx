...
const CloseRea = () => {
  ...
  const tabs = ["All", "Follow Up", "My Reasons"];
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ reason: "", description: "", createdBy: "", modifiedBy: "" });
    setShowForm(false);
  };
  ...
  const filteredData =
    tab === "All"
      ? data
      : tab === "Follow Up"
      ? data.filter((d) => d.reason?.toLowerCase().includes("follow up"))
      : data.filter((d) => d.createdBy?.toLowerCase() === "me");
  ...
  return (
    <div className="p-4 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-[15px] font-medium">{tab} Reasons</h2>
