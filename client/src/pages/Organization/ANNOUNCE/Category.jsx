...
import { Plus, Pencil, Trash2, Download, Settings2 } from "lucide-react";
...
const Category = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ category: "", addedBy: "", modifiedBy: "" });
    setShowForm(false);
  };
        ...
        <table className="w-full text-sm">
          <thead className="bg-blue-50 text-[11px]">
            <tr>
              ...
              <th className="p-2 text-left">Manage Popup Config</th>
