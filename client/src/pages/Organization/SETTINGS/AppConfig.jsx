  ...
  return (
    <div className="p-4 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-medium">Approval Flow</h2>
        <div className="flex items-center gap-2">
          ...
          />
          <button className="border border-gray-300 cursor-pointer hover:bg-gray-500 hover:text-white p-2 rounded-full">
            <Folder size={15} />
          </button>
          <button
            className="border border-gray-300 cursor-pointer hover:bg-blue-500 hover:text-white p-2 rounded-full"
            onClick={() => {
              setFormData({ name: "", autoApprove: false, autoReject: false, steps: "" });
              setEditingIndex(null);
              setShowForm(true);
            }}
          >
        ...
        <table className="w-full text-sm">
          <thead className="bg-blue-50 text-xs text-left">
            <tr>
              ...
              <th className="p-2">Auto Approve</th>
              <th className="p-2">Auto Reject</th>
            ...
            {filteredData.length > 0 ? (
              filteredData.map((row, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="p-2">{row.autoApprove ? "Yes" : "No"}</td>
                  <td className="p-2">{row.autoReject ? "Yes" : "No"}</td>
                  <td className="p-2">{row.steps}</td>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-4 w-4"
              />
              <label htmlFor="autoReject" className="text-sm">Auto Reject</label>
            </div>
            <div>
              <label className="block mb-1 text-sm">Steps*</label>
              <textarea
                name="steps"
