...
const AssCateg = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ category: "", modifiedBy: "" });
    setShowForm(false);
  };
  ...
  const filteredData = searchCategory
    ? data.filter((item) => item.category === searchCategory)
    : data;
  ...
  return (
    <div className="p-4 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-[15px] font-medium">Asset Category Config</h2>
        ...
        <table className="w-full text-sm">
          <thead className="bg-blue-50 text-[11px]">
            <tr>
              ...
              <th className="p-2 text-left">View Assets</th>
