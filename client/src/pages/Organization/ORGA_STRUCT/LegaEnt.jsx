  ...
  return (
    <div className="p-4 border border-gray-300 rounded-lg focus:ring-0 focus:outline-none   min-h-screen ">
      ...
      <div className="flex pt-2 justify-between items-center mb-4">
        <h2 className="text-[15px] font-bold">Legal Entities</h2>
        ...
        <table className="w-full ">
          <thead className="bg-blue-100 text-[10px]">
            <tr>
              ...
              <th className="p-2 text-left">Entity Head</th>
      ...
      {showForm && (
        <div className="fixed inset-0  bg-opacity-40 flex items-center justify-center z-50">
          ...
          >
            <div>
              <label className="block mb-1 text-sm font-medium">Entity Name*</label>
              <input
                name="entityName"
            ...
            <div>
              <label className="block mb-1 text-sm font-medium">Entity Head*</label>
              <input
                name="entityHead"
