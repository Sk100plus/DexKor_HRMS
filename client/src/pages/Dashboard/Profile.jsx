...
const goToSetting=()=>{
  ...
  return (
    <div className="flex justify-between items-center py-5   ">
      {/* Left: Page Title */}
      <h3 className="text-lg font-semibold cursor-pointer" onClick={()=>navigate('/')}>All Employees</h3>
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-200 z-10">
            <ul className="text-sm text-gray-700">
              <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={goToAccount}>Account</li>
              <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={goToSetting}>Settings</li>
