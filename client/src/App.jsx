...
function App() {
  return (
    <HashRouter>
      {/* Navbar is optional, uncomment if needed */}
      {/* <Navbar /> */}
      <main className="w-full min-h-screen">
        <Routes>
          {/* Root route (when user lands at base path) */}
          <Route path="/" element={<Dashboard />} />

          {/* App Routes */}
          <Route path="/DexKor_HRMS" element={<Dashboard />} />
          <Route path="/DexKor_HRMS/allDepartment" element={<AllDept />} />
          <Route path="/DexKor_HRMS/allDepartment/department/:name" element={<DepartmentDetail />} />
